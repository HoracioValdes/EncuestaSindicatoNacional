        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col s10 offset-s1">
                    <h2><b>Encuesta</b></h2>
                    <p class="flow-text" align="justify">En este formulario debes responder las preguntas de la encuesta.</p>
                    <p class="flow-text" align="justify">- Puede consultar la información ingresada en esta encuesta ingresando a la sección del menú 'Modificar y eliminar encuesta'.</p>
                    <p class="flow-text" align="justify">- En esa sección también podrá reingresar los datos de la encuesta, o eliminarla.</p>
                </div>
            </div>

            <div class="row">
                <form class="col s10 offset-s1" name="form" action="responder.do?rut=${sessionScope.socioValido.rut}" method="post">
                    ...
                    <br/>
                    <div class="row">
                        <button class="btn waves-effect blue lighten-1" type="submit" name="action" onclick="return validar();" value="ingresar">Ingresar<i class="material-icons right">send</i></button>
                    </div>
                    <br/>
                    <div class="row">
                        <a class="waves-effect blue lighten-1 btn" href="encuesta.do"><i class="material-icons left">backspace</i>Limpiar formulario</a>
                    </div>
                </form>
            </div>

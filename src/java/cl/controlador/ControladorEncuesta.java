...
import cl.modelo.Encuesta_buscada;
 ...
 * @author Horacio
 */
@WebServlet(name = "ControladorEncuesta", urlPatterns = {"/encuesta.do", "/responder.do", "/modificar.do", "/manipular.do"})
public class ControladorEncuesta extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        ArrayList<Educacion_socio> listaEducacion;
        ArrayList<Estado_civil_socio> listaEstadoCivil;
        ArrayList<Vivienda_socio> listaVivienda;
        ArrayList<Tipo_cargo> listaCargo;
        ArrayList<Area_funcion> listaFuncion;
        ...
        if (userPath.equals("/encuesta.do")) {
